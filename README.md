...
在 8×海光 K100-AI 64GB（gfx928，DTK 26.04）上，将 **DeepSeek-V4-Flash**（284B MoE，激活 13B）部署为 OpenAI 兼容服务的完整实录：**四条线路**全部跑通（含自研 int4 线），36 轮调优记录、十余个自研补丁、完整测试与量化工具链，以及提交给海光的两份详细 Bug 报告。
